...
After batch 41, **3,482 verified**, **5,382 remaining** — roughly 27 more
...
Resume from quest ID 8141 (batch 42, target range roughly 8141–8340) following the same
two-phase methodology, skipping any ID present in `skip-list.tsv`. 5,382 quest IDs remain
after batch 41 (see Total scope note above).
