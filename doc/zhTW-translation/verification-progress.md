...
After batch 39, **3,274 verified**, **5,590 remaining** — roughly 27 more
...
Resume from quest ID 7741 (batch 40, target range roughly 7741–7940) following the same
two-phase methodology, skipping any ID present in `skip-list.tsv`. 5,590 quest IDs remain
after batch 39 (see Total scope note above).
