...
span 1–26034, one fewer than before — quest 6843 removed to `skip-list.tsv`, batch 35). After
batch 35, **3,050 verified**, **5,816 remaining** — roughly 29 more
...
Resume from quest ID 6941 (batch 36, target range roughly 6941–7140) following the same
two-phase methodology, skipping any ID present in `skip-list.tsv`. 5,816 quest IDs remain
after batch 35 (see Total scope note above).
