...
span 1–26034). After batch 37, **3,123 verified**, **5,743 remaining** — roughly 28 more
...
Resume from quest ID 7341 (batch 38, target range roughly 7341–7540) following the same
two-phase methodology, skipping any ID present in `skip-list.tsv`. 5,743 quest IDs remain
after batch 37 (see Total scope note above).
...
new "wowhead showing wrong-era content" methodology entry in Established terms) — the tell is a
