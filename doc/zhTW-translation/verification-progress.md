...
After batch 43, **3,810 verified**, **5,054 remaining** — roughly 25 more
...
- **`喚風者梅恩·長角` wrong-NPC substitution (AQ War Effort / Cenarion Hold cluster, found
  batch 43)** — this name is being used as an incorrect stand-in for **at least 3 different real
  turn-in NPCs** (confirmed: Windcaller Proudhorn `喚風者傲角`, Bor Wildmane `鮑爾·蠻鬃`,
  Commander Mar'alith `指揮官瑪爾利斯`) across a name that appears **29 times total** in the
  corpus. Only the 5 in-batch instances (8496/8534/8535/8537/8538) have been individually
  verified and fixed; the other ~24 (quest IDs 8556, 8697–8704, 8732, 8737–8740, 8778–8782,
  8786/8787, 8807/8808/8810 at last count) are unswept — **do not blind-replace**, each occurrence
  needs its own correct-NPC check against the English source (or the row's own `ObjectiveText4`
  field, which was reliably correct in every case checked so far).
