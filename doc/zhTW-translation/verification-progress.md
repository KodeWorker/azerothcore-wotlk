...
**Total scope**: `quest_template_locale` in this pending file holds **8,859 quest rows** (IDs
span 1–26034, seven fewer than before — quests 7681/7682 removed batch 39, quest 9750 removed
batch 50, quests 10452/10453 removed batch 53, quests 11402/11493 removed batch 58, all to
`skip-list.tsv`).
After batch 58, **6,672 verified**, **2,187 remaining** — roughly 11 more
...
Resume from quest ID 11541 (batch 59), skipping any ID present in `skip-list.tsv`. See the
