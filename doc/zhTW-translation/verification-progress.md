...
After batch 40, **3,402 verified**, **5,462 remaining** — roughly 27 more
...
Resume from quest ID 7941 (batch 41, target range roughly 7941–8140) following the same
two-phase methodology, skipping any ID present in `skip-list.tsv`. 5,462 quest IDs remain
after batch 40 (see Total scope note above).
