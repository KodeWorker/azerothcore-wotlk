...
After batch 44, **4,008 verified**, **4,856 remaining** — roughly 24 more
...
- **`喚風者梅恩·長角` wrong-NPC substitution (AQ War Effort / Cenarion Hold cluster, found
  batch 43, extended batch 44)** — this name is being used as an incorrect stand-in for
  **at least 4 different real turn-in NPCs** (confirmed: Windcaller Proudhorn `喚風者傲角`,
  Bor Wildmane `鮑爾·蠻鬃`, Commander Mar'alith `指揮官瑪爾利斯`, and — batch 44's addition —
  Krug Skullsplit `克魯格·碎顱`, a non-Windcaller Orgrimmar-Legion officer entirely, quest 8732)
  across a name that appeared **29 times total** in the corpus. 18 instances now verified and
  fixed (5 in batch 43: 8496/8534/8535/8537/8538; 13 in batch 44: the ring-questline's own 9×
  `喚風者耶薩德拉` — 8556/8697–8704 — plus 3× `喚風者傲角` — 8738/8739/8740 — plus 8732's
  `克魯格·碎顱`). ~10 remain unswept (quest IDs 8778–8782, 8786/8787, 8807/8808/8810 at last
  count) — **do not blind-replace**, each occurrence needs its own correct-NPC check against the
  English source (or the row's own `ObjectiveText4`/`Objectives` field, which was reliably
  correct in every case checked so far).
