...
span 1–26034). After batch 36, **3,095 verified**, **5,771 remaining** — roughly 29 more
...
Resume from quest ID 7141 (batch 37, target range roughly 7141–7340) following the same
two-phase methodology, skipping any ID present in `skip-list.tsv`. 5,771 quest IDs remain
after batch 36 (see Total scope note above).
