...
INSERT INTO `achievement_reward_locale` (`ID`, `Locale`, `Subject`, `Text`) VALUES (2536,'zhTW','堆積如山的坐騎','我聽說現在你的坐騎數量幾乎要和我一樣多了，真令人欽佩啊！也許你能幫我一件事情，我這裡有太多的龍鷹了，希望你能給它一個家？ 當然，它是被訓練成一隻合格的坐騎而不是，額，獵人的寵物。你會發現它的優點：不知疲倦，用不完的力氣。哈哈。$B$B - 梅·法蘭西斯');
DELETE FROM `achievement_reward_locale` WHERE `ID` = 2537 AND `Locale` = 'zhTW';
INSERT INTO `achievement_reward_locale` (`ID`, `Locale`, `Subject`, `Text`) VALUES (2537,'zhTW','堆積如山的坐騎','我聽說現在你的坐騎數量幾乎要和我一樣多了，真令人欽佩啊！也許你能幫我一件事情，我這裡有太多的龍鷹了，希望你能給它一個家？ 當然，它是被訓練成一隻合格的坐騎而不是，額，獵人的寵物。你會發現它的優點：不知疲倦，用不完的力氣。哈哈。$B$B - 梅·法蘭西斯');
...
INSERT INTO `achievement_reward_locale` (`ID`, `Locale`, `Subject`, `Text`) VALUES (2957,'zhTW','奧杜爾團隊高手的榮耀','親愛的$N，$B$B我希望你能繼續努力加油，這樣我們就能奪回對奧杜爾的控制權。$B$B我的那些探險者協會的小夥子們決定送你這隻鐵鏽始祖幼龍作為你的獎勵。$B$B我想你會很喜歡它吧。你們團隊在奧杜爾的征程將銘記史冊，繼續奮鬥吧。$B$B布萊恩·銅鬚');
DELETE FROM `achievement_reward_locale` WHERE `ID` = 2958 AND `Locale` = 'zhTW';
INSERT INTO `achievement_reward_locale` (`ID`, `Locale`, `Subject`, `Text`) VALUES (2958,'zhTW','英雄：奧杜爾團隊高手的榮耀','親愛的$N，$B$B我希望你能繼續努力加油，這樣我們就能奪回對奧杜爾的控制權。$B$B我的那些探險者協會的小夥子們決定送你這隻鐵縛始祖幼龍作為你的獎勵。$B$B我想你會很喜歡它吧。你們團隊在奧杜爾的征程將銘記史冊，繼續奮鬥吧。$B$B布萊恩·銅鬚');
